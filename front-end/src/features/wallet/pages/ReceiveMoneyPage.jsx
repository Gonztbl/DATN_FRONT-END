...
export default function ReceiveMoneyPage() {
    ...
    const handleDownloadQR = async () => {
        try {
            if (!qrCode) {
                showWarning("Missing QR", "No QR code to download");
                return;
            }

            // Convert base64 to blob and download
            const base64Data = typeof qrCode === 'string' && qrCode.startsWith('data:')
                ? qrCode
                : `data:image/png;base64,${qrCode}`;

            // Fetch to convert to blob
            ...
            showError("Download Failed", "Failed to download QR code");
        }
    };
    ...
    const handleGenerateQR = async () => {
        ...
        try {
            ...
            showError("Generation Failed", "Failed to generate QR code");
        }
    };
    ...
    const handleShare = async () => {
        if (navigator.share && qrCode) {
            ...
            showError("Share Error", "Sharing not supported on this device");
        }
    };
